// shared/reference-data/country-codes.ts
...
export const COUNTRY_CODES = [
  ...
  /**
   * Union type of all allowed country codes
   * Example: 'ES' | 'FR' | 'US' | ...
   */
  export type CountryCodeValue = typeof COUNTRY_CODES[number]
  ...
  /**
   * Checks if a string is a valid ISO country code (case-insensitive)
   */
  export function isValidCountryCodeValue(code: string): boolean {
    return COUNTRY_CODE_SET.has(code.toUpperCase())
  }
  
  /**
   * Normalizes a country code to uppercase
   */
